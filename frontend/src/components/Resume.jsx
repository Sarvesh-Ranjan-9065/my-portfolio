    ...
    <section id="resume" className="section-shell" style={{ padding: '80px 48px', maxWidth: '1200px', margin: '0 auto' }}>
        ...
        {[{ key: 'brief', label: 'Brief View' }, { key: 'full', label: 'Full Preview' }].map(tab => (
          <button
            ...
            style={{
              ...
              border: view === tab.key ? '1px solid var(--cyan)' : '1px solid rgba(var(--cyan-r), var(--cyan-g), var(--cyan-b), 0.12)',
              background: view === tab.key ? 'rgba(var(--cyan-r), var(--cyan-g), var(--cyan-b), 0.1)' : 'transparent',
      ...
      {view === 'brief' ? (
        <div className="resume-grid">
          <SpotlightCard className="!p-0 !bg-transparent !border-0" spotlightColor="rgba(var(--cyan-r), var(--cyan-g), var(--cyan-b), 0.23)">
